        ...
        <div className="md:col-span-3 text-center md:text-left">
          ...
          <div className="mt-2 min-h-[40px] md:min-h-[48px]">
            <h2 className="text-2xl md:text-3xl font-semibold text-sky-400">
              ...
              {typedTitle !== PROFILE.title && (
                <span
                  className="inline-block w-[3px] h-7 md:h-8 bg-sky-400 ml-1 animate-pulse"
          ...
          <FadeIn
            direction="up"
            delay={600}
            className="mt-8 flex items-center justify-center md:justify-start gap-4 flex-wrap"
          >
            <a
